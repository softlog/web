...
import json
from flask import (
    flash, redirect, send_file, jsonify, make_response, url_for, session, abort, request)
from app._compat import as_unicode
from app.filemanager import uuid_originalname
from app.widgets import GroupFormListWidget, ListMasterWidget
from app.baseviews import BaseView, BaseCRUDView, BaseFormView, expose, expose_api
from app.security.decorators import has_access, permission_name, has_access_api
from app.urltools import *
from app.const import FLAMSG_ERR_SEC_ACCESS_DENIED
...
class IndexView(BaseView):
    ...
    @expose('/')
    def index(self):
        #return redirect("http://softlog.online")
...
class SimpleFormView(BaseFormView):
    ...
    @has_access    
    @permission_name("Ver_formulario")
    ...
    @has_access
    @permission_name("Gravar_formulario")
...
class ModelSoftlogView(RestCRUDView):
    """
        This is the CRUD generic view.
        If you want to automatically implement create, edit,
        delete, show, and list from your database tables, inherit your views from this class.
    ...
    def __init__(self, **kwargs):
        ...
        super(ModelSoftlogView, self).__init__(**kwargs)
    ...
    def _get_list_widget(self, filters,
        ...
        widgets['list'] = self.list_widget(title=self.title, label_columns=self.label_columns,
...
class ModelSoftlogGridView(ModelSoftlogView):
    pass
