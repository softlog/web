...
def get_boleto_caixa_sig14(faturas,remessa):
    ...
    for fatura in faturas:
        ...
        d.demonstrativo = [
            "- Servi�o Transporte: RS %s " % (format_value(fatura['valor_fatura'])),
            "- Total R$ %s " % (format_value(fatura['valor_fatura']))
            ]
...
def get_boleto_caixa_cs(faturas,remessa):
    ...
    for fatura in faturas:
        ...
        d.demonstrativo = []
        d.demonstrativo.append("- Servi�o Transporte: RS %s " % (format_value(fatura['valor_fatura'])))
        ...
        d.demonstrativo.append("- Total R$ %s " % (format_value(fatura['valor_boleto'])))
...
def get_boleto_bradesco(faturas,remessa):
    ...
    for fatura in faturas:
        ...
        d.demonstrativo = [
            ...
            "- Total R$ %s " % ("{0:0.2f}".format(fatura['valor_fatura']))
            ]
