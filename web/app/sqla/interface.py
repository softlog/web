...
from app.sqla import filters
from sqlalchemy.orm import joinedload
from sqlalchemy.exc import IntegrityError
from sqlalchemy import func

from app.sqla.models.base import BaseInterface
from app.sqla.models.group import GroupByDateYear, GroupByDateMonth, GroupByCol
from app.sqla.models.mixins import FileColumn, ImageColumn
from app.filemanager import FileManager, ImageManager
from app._compat import as_unicode
from app.const import LOGMSG_ERR_DBI_ADD_GENERIC, LOGMSG_ERR_DBI_EDIT_GENERIC, LOGMSG_ERR_DBI_DEL_GENERIC, \
...
class SQLAInterface(BaseInterface):
    ...
    def query(self, filters=None, order_column='', order_direction='',
        ...
        elif order_column or order_column.strip() != '':            
            order_column = self.obj.__tablename__ + '.' + order_column.split('.')[-1]
